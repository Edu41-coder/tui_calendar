...
document.addEventListener("DOMContentLoaded", function () {
            ...
            function (error, response) {
              if (!error) {
                ...
                CalendarBackend.loadEvents(start, end, function (error, events) {
                  if (error) {
                    console.error(
                      "Erreur lors du rechargement des événements:",
                      error
                    );
                    return;
                  }
    ...
    function removeAllArrows() {
      ...
      document
        .querySelectorAll(".event-extension-arrow")
    ...
    function addExtensionArrows(calendar, calendarIds) {
      ...
      setTimeout(() => {
        const events = document.querySelectorAll(
          ".tui-full-calendar-time-schedule,.tui-full-calendar-weekday-schedule"
        );
        ...
        events.forEach((event) => {
          ...
          console.log("Ajout réel des flèches dans :", contentElement);
